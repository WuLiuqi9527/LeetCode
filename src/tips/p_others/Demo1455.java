...
public class Demo1455 {
    ...
    public static void main(String[] args) {
        System.out.println(new Demo1455().isPrefixOfWord("i love eating burger", "burg"));
        System.out.println(new Demo1455().isPrefixOfWord("this problem is an easy problem", "pro"));
        System.out.println(new Demo1455().isPrefixOfWord("i am tired", "you"));
    }
}
